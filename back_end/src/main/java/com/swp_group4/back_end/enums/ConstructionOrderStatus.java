...
public enum ConstructionOrderStatus {
    ...
    CONFIRM_DESIGN, // Trạng thái của DESIGN sau khi được phê duyệt từ MANAGER// Trạng thái của CONSTRUCTION ORDER sau khi CUSTOMER thanh toán lần 1 và MANAGER assign 1 LEADER DESIGNER
